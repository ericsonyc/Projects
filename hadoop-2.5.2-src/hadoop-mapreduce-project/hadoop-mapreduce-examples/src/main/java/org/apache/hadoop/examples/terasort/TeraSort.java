...
public class TeraSort extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		getConf().setInt("mapreduce.map.memory.mb", 3072);
		getConf().setInt("mapreduce.map.cpu.vcores", 2);
		getConf().setInt("mapreduce.reduce.memory.mb", 2048);
		getConf().setInt("mapreduce.reduce.cpu.vcores", 1);
